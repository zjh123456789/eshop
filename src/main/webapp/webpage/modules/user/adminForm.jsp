...
<form:form id="inputForm" modelAttribute="user" action="${ctx}/admin/save" method="post" class="form-horizontal">
    <form:hidden path="id"/>
    ...
    <table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
        ...
        <tr>
            <td class="width-15 active"><label class="pull-right required"><font color="red">*</font>角色：</label></td>
            <td class="width-35">
                <form:select path="role.id" class="form-control">
                    <form:options items="${fns:getRole()}" itemLabel="label" itemValue="value" htmlEscape="false"/>
                </form:select></td>
        </tr>
        <tr>
