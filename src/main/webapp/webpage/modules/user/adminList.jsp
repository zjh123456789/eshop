...
<div class="wrapper wrapper-content">
    <div class="ibox">
        ...
        <div class="ibox-content">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <form:form id="searchForm" modelAttribute="user" action="${ctx}/admin/list/" method="post"
                               class="form-inline">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="pull-left">
                        <table:addRow url="${ctx}/admin/form" title="管理员"></table:addRow><!-- 增加按钮 -->
                        <table:editRow url="${ctx}/admin/form" title="管理员" id="contentTable"></table:editRow><!-- 编辑按钮 -->
                        <table:delRow url="${ctx}/admin/deleteAll" id="contentTable"></table:delRow><!-- 删除按钮 -->
                        <table:importExcel url="${ctx}/admin/import"></table:importExcel><!-- 导入按钮 -->
                        <table:exportExcel url="${ctx}/admin/export"></table:exportExcel><!-- 导出按钮 -->
            ...
            <table id="contentTable"
                ...
                <tr>
                    ...
                    <th class="sort-column role.id">角色</th>
                ...
                <c:forEach items="${page.list}" var="user">
                    <tr>
                        ...
                        <td>
                            <button onclick="openDialogView('查看用户', '${ctx}/admin/form?id=${user.id}','800px', '500px')"
                                    class="btn btn-info btn-xs"><i class="fa fa-search-plus"></i> 查看
                            </button>
                            <c:if test="${user.id != Constants.USER_SUPER_ADMIN_ID}">
                                <button
                                        onclick="openDialog('修改用户', '${ctx}/admin/form?id=${user.id}','800px', '500px')"
                                        class="btn btn-success btn-xs"><i class="fa fa-edit"></i> 修改
                                </button>
                                <a href="${ctx}/admin/delete?id=${user.id}"
