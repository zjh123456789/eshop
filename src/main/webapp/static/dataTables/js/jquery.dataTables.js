 ...
 * @Autuor      SpryMedia Ltd (www.sprymedia.co.uk)
...
(function( factory ) {
	...
	if ( typeof define === 'function' && define.amd ) {
		...
		define( 'datatables', ['src/main/webapp/static/dataTables/js/jquery'], factory );
	}
	else if ( typeof exports === 'object' ) {
		// Node/CommonJS
		module.exports = factory( require( 'src/main/webapp/static/dataTables/js/jquery' ) );
	}
...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlInfo ( settings )
	{
		...
		if ( ! nodes ) {
			...
			// Table is introduced by our info div
			$(settings.nTable).attr( 'aria-introducedby', tid+'_info' );
		}
	...
	DataTable.ext = _ext = {
		 ...
		 * Feature plug-ins.
		 * 
		 * This is an array of objects which introduce the feature plug-ins that are
		 * available to DataTables. These feature plug-ins are then available for
		 * use through the `dom` initialisation option.
		 * 
		 * Each feature plug-in is introduced by an object which must have the
		 ...
		 * (parameters introduced below) that is called for every row in the table,
		...
		type: {
			 ...
			 *
			 * Each ordering option can be introduced by three properties added to
			 * this object:
			 *
